...
Technical evaluators: CTOs, engineering leads, and senior developers assessing a full-stack Web3 engineer. They read code, understand architecture, and value demonstrated depth over surface-level design flair. They arrive skeptically and leave if the signal-to-noise is low. Secondary audience: technical recruiters at global tech companies who need to quickly extract value and forward to a hiring manager.
...
- Generic Bootstrap/template portfolios: blue-gray palette, "I'm a developer" hero, zero identity.
- Overdesigned cursor-particle-3D portfolios: animations that perform instead of communicate, distract from the work being showcased.
- Corporate/LinkedIn-style blandness: overly formal, no edge, indistinguishable from a resume PDF.
...
WCAG 2.1 AA. Dark theme with sufficient contrast (≥4.5:1 for body text). All animations respect `prefers-reduced-motion`. Keyboard navigable. Screen-reader friendly with semantic HTML and proper alt text.
